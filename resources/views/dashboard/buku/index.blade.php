                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row justify-content-between">
                                ...
                                <a href="{{ route('create')}}" class="btn btn-primary mx-3 mb-3 btn-rounded btn-fw">Tambah Data</a>
                            </div>
                                        ...
                                        @foreach ($data as $dat)
                                            <tr>
                                                ...
                                                <td style="width: 80%" class="float-right">
                                                    <a class="btn btn-warning m-1" href="{{ route('edit', $dat->id) }}"><span
                                                        class="bi bi-pencil"></span> Edit</a>
                                                    <form action="{{ route('destroy', $dat->id) }}"
